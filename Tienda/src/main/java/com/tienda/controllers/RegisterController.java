...
import com.tienda.service.IRegisterService;
...
public class RegisterController {
    ...
    @GetMapping("/activacion/{usuario}/{idUsuario}") 
    public String activar (
            Model model,
            @PathVariable(value = "usuario") String usuario, 
            @PathVariable(value = "idUsuario") String id) { 
...
//         registerService.activar(usuario, imagenFile);
//        return "/redirect:/"; 
//    }
